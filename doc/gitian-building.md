...
*Setup instructions for a gitian build of Slingcoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Slingcoin
...
- [Building Slingcoin](#building-sling)
...
git clone https://github.com/eastcoastcrypto/Slingcoin.git
cd sling
...
To build Slingcoin (for Linux, OSX and Windows) just follow the steps under 'perform
...
```bash
    ...
    From https://github.com/eastcoastcrypto/Slingcoin
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/Slingcoin.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit sling=${COMMIT} --url sling=${URL} ../Slingcoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit sling=${COMMIT} --url sling=${URL} ../Slingcoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit sling=${COMMIT} --url sling=${URL} ../Slingcoin/contrib/gitian-descriptors/gitian-osx.yml
```
