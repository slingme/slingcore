...
In order to support loading of multiple wallets in sling-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sling.cpp.
...
Changes to sling.cpp
----------------------
sling.cpp is the entry point into sling-qt, and as such, will require some minor modifications to provide hooks for
