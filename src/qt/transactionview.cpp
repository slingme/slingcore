                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Slingcoin from zSLING"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSLING"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSLING));
