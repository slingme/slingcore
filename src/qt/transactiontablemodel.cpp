...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Slingcoin to zSLING");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zSLING");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Slingcoin from zSLING");
    case TransactionRecord::ZerocoinSpend_Change_zSLING:
        return tr("Minted Change as zSLING from zSLING Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zSLING to Slingcoin");
