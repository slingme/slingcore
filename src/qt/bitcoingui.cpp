                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Slingcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Slingcoin address"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSLING"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Slingcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Slingcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Slingcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Slingcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Slingcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Slingcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Slingcoin Core help message to get a list with possible Slingcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Slingcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Slingcoin network", "", count));
}
...
{
    QString strTitle = tr("Slingcoin Core"); // default title
...
/** Creates context menu, its actions, and slings up all the relevant signals for mouse events. */
