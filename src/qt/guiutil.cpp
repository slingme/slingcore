...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Slingcoin address (e.g. %1)").arg("PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp"));
#endif
...
{
    // return if URI is not valid or is no Slingcoin: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Slingcoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Slingcoin.lnk
