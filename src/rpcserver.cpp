...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Slingcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Slingcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"sling", "listmasternodes", &listmasternodes, true, true, false},
        {"sling", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sling", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sling", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sling", "masternodedebug", &masternodedebug, true, true, false},
        {"sling", "startmasternode", &startmasternode, true, true, false},
        {"sling", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sling", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sling", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sling", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sling", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sling", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sling", "mnbudget", &mnbudget, true, true, false},
        {"sling", "preparebudget", &preparebudget, true, true, false},
        {"sling", "submitbudget", &submitbudget, true, true, false},
        {"sling", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sling", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sling", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sling", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sling", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sling", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sling", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sling", "checkbudgets", &checkbudgets, true, true, false},
        {"sling", "mnsync", &mnsync, true, true, false},
        {"sling", "spork", &spork, true, true, false},
        {"sling", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"sling", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
