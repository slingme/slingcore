...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total sling balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zSLINGsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSLING denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSLING denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSLING denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSLING denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSLING denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSLING denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSLING denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSLING denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSLING denominations\n"
            "  }\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zslingObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zslingObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zSLINGsupply", zslingObj));
...
#ifdef ENABLE_WALLET
        // Case 1: Slingcoin address and we have full public key:
