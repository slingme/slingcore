...
RESOURCES += src/qt/sling.qrc src/qt/sling_locale.qrc

TRANSLATIONS += src/qt/locale/sling_bg.ts \
                src/qt/locale/sling_de.ts \
                src/qt/locale/sling_en.ts \
                src/qt/locale/sling_es.ts \
                src/qt/locale/sling_fi.ts \
                src/qt/locale/sling_fr.ts \
                src/qt/locale/sling_it.ts \
                src/qt/locale/sling_ja.ts \
                src/qt/locale/sling_pl.ts \
                src/qt/locale/sling_pt.ts \
                src/qt/locale/sling_ru.ts \
                src/qt/locale/sling_sk.ts \
                src/qt/locale/sling_sv.ts \
                src/qt/locale/sling_vi.ts \
                src/qt/locale/sling_zh_CN.ts \
                src/qt/locale/sling_zh_TW.ts
