Contributing to Slingcoin Core
============================

The Slingcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Slingcoin Core project, and is not to be
confused with overall Slingcoin Network Protocol consensus changes.

Whether a pull request is merged into Slingcoin Core rests with the project merge
...
Patches that change Slingcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Slingcoin consensus, it must have been
...
The project leader is the release manager for each Slingcoin Core release.
